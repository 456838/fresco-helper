...
public class PhotoWallActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String[] images = {
                "https://img5q.duitang.com/uploads/item/201402/24/20140224212510_eQRG5.thumb.700_0.jpeg",
        ...
        PhotoInfo photoInfo = new PhotoInfo();
        String url = "https://photo.zastatic.com/images/photo/254450/1017799453/10791629802196501.png";
        photoInfo.originalUrl = url;
        photoInfo.thumbnailUrl = "https://photo.zastatic.com/images/photo/254450/1017799453/10791629802196501.png?imageMogr2/format/webp/quality/85/thumbnail/120x120";
        data.add(photoInfo);

        photoInfo = new PhotoInfo();
        url = "https://photo.zastatic.com/images/photo/546/2181053/1337583826543.jpg";
        photoInfo.originalUrl = url;
        photoInfo.thumbnailUrl = "https://photo.zastatic.com/images/photo/546/2181053/1337583826543.jpg?imageMogr2/format/webp/quality/85/thumbnail/120x120";
        data.add(photoInfo);

        url = "http://tupian.enterdesk.com/2016/dqd/03/1401/11.jpg";
        photoInfo.originalUrl = url;
