package com.salton123.widget.photo;
...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    private ControllerListener mControllerListenerDelegate;
    ...
    public void setPhotoUri(Uri uri, Uri lowResUri) {
        setPhotoUri(uri, lowResUri, null);
    }

    public void setPhotoUri(Uri photoUri, Uri lowResUri, @Nullable Context context) {
        mEnableDraweeMatrix = false;
        DraweeController controller = Fresco.newDraweeControllerBuilder()
                .setCallerContext(context)
                .setLowResImageRequest(ImageRequest.fromUri(lowResUri))
                .setImageRequest(ImageRequest.fromUri(photoUri))
                .setOldController(getController())
                .setControllerListener(new BaseControllerListener<ImageInfo>() {
                    @Override
                    public void onFailure(String id, Throwable throwable) {
                        if (mControllerListenerDelegate != null) {
                            mControllerListenerDelegate.onFailure(id, throwable);
                        }
                        mEnableDraweeMatrix = false;
                    }
                    ...
                    public void onFinalImageSet(String id, ImageInfo imageInfo,
                        ...
                        if (mControllerListenerDelegate != null) {
                            mControllerListenerDelegate.onFinalImageSet(id, imageInfo, animatable);
                        }
                    ...
                    public void onIntermediateImageFailed(String id, Throwable throwable) {
                        if (mControllerListenerDelegate != null) {
                            mControllerListenerDelegate.onIntermediateImageFailed(id, throwable);
                        }
                        mEnableDraweeMatrix = false;
                    }
                    ...
                    public void onIntermediateImageSet(String id, ImageInfo imageInfo) {
                        if (mControllerListenerDelegate != null) {
                            mControllerListenerDelegate.onIntermediateImageSet(id, imageInfo);
                        }
                        mEnableDraweeMatrix = true;
                        if (imageInfo != null) {
                            update(imageInfo.getWidth(), imageInfo.getHeight());
    ...
    public void setLongPicScale(boolean longPicScale) {
        mAttacher.setLongPicScale(longPicScale);
    }
    
    public void setControllerListenerDelegate(ControllerListener controllerListenerDelegate) {
        mControllerListenerDelegate = controllerListenerDelegate;
    }
}
